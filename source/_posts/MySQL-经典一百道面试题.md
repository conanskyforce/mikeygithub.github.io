...
![avatar](/resource/img/jzsyhfzjsy.png)
...
![avatar](/resource/img/bgs.png)

乐观锁：
乐观锁的“乐观情绪”体现在，它认为数据的变动不会太频繁。因此，它允许多个事务同时对数据进行变动。实现方式：乐观锁一般会使用版本号机制或CAS算法实现。

![avatar](/resource/img/lgs.png)
...
![avatar](/resource/img/mysql-master-salve.png)
...
![avatar](/resource/img/mysql-jiagou.png)
...
![avatar](/resource/img/mysql-lock.png)
...
![avatar](/resource/img/mysql-dead-lock.png)
...
![avatar](/resource/img/sql-zxsx.png)
...
![avatar](/resource/img/mysql-copy.png)
